...
<head>
    ...
    <style> 
        ...
        @media print {
            ...
            .print-shadow-none { box-shadow: none !important; border-color: black !important; }
        }
    </style>
</head>
<body class="bg-gray-100 min-h-screen flex items-center py-10">
    <div class="container max-w-md mx-auto p-4 sm:p-6 lg:p-0">
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden print-shadow-none relative">
            ...
            <div class="hidden sm:block absolute top-[140px] -left-4 w-8 h-8 bg-gray-100 rounded-full border-r border-gray-200 no-print"></div>
            <div class="hidden sm:block absolute top-[140px] -right-4 w-8 h-8 bg-gray-100 rounded-full border-l border-gray-200 no-print"></div>
            ...
            <div class="px-8 py-6 text-center border-b-2 border-dashed border-gray-200 bg-gray-50">
                ...
                <div class="mt-3 flex justify-center h-8 space-x-1 opacity-50">
                    <div class="w-1 bg-gray-800"></div><div class="w-2 bg-gray-800"></div><div class="w-1 bg-gray-800"></div><div class="w-3 bg-gray-800"></div><div class="w-1 bg-gray-800"></div><div class="w-2 bg-gray-800"></div><div class="w-2 bg-gray-800"></div><div class="w-1 bg-gray-800"></div><div class="w-3 bg-gray-800"></div><div class="w-1 bg-gray-800"></div><div class="w-2 bg-gray-800"></div>
                </div>
            </div>
            ...
            <div class="p-8 space-y-5">
                ...
                <div class="flex justify-between items-end border-b border-gray-100 pb-2">
                    ...
                    <span class="text-sm font-bold text-gray-800 text-right">{{ \Carbon\Carbon::parse($data->tanggal_titip)->format('d M Y') }}</span>
                </div>

                <div class="flex justify-between items-end border-b border-gray-100 pb-2">
                    <span class="text-sm font-semibold text-gray-500">Batas Ambil</span>
                    <span class="text-sm font-bold text-red-600 text-right">{{ \Carbon\Carbon::parse($data->tanggal_rencana_ambil)->format('d M Y') }}</span>
                </div>
        ...
        <div class="mt-6 space-y-3 no-print">
            <button onclick="window.print()" class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-green-600 hover:bg-green-700 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                Cetak / Simpan PDF
            </button>
            <a href="{{ route('penitipan.form') }}" class="w-full flex justify-center items-center py-3 px-4 rounded-xl text-sm font-bold text-gray-600 bg-white border border-gray-300 hover:bg-gray-50 transition-colors">
